        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            <a href="#" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-black text-xl text-white tracking-tight">Cható</span>
            </a>
            ...
            <div className="flex gap-3">
              {socialLinks.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className="w-8 h-8 rounded-lg bg-gray-800 hover:bg-violet-600 flex items-center justify-center transition-colors duration-200"
                >
                  {s.icon}
                </a>
              ))}
